...
const MountainVistaParallax = ({ title = '', subtitle = '' }) => {
  ...
  return (
    <section
      className="hero-container absolute inset-0 overflow-hidden pointer-events-none z-0"
    ...
    >
      ...
      {layersData.map(layer => (
        <div
          key={layer.className}
          className={`parallax-layer absolute inset-0 bg-repeat-x bg-bottom animate-[parallax_fg_linear_infinite] ${layer.className}`}
